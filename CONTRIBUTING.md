...
# WorldPECore Contribution Guidelines

Before contributing to WorldPECore, please read this.

## I want to create an issue
* First, use the [Issue Search](https://github.com/kotyaralih/WorldPECore/search?ref=cmdform&type=Issues) to check if anyone has reported it.
...
* Use the [Pull Request](https://github.com/kotyaralih/WorldPECore/pull/new) system, your request will be checked and discussed.
* __Create a single branch for that pull request__
* If you want to be part of WorldPECore, we will ask you to.
* Code using the syntax as in WorldPECore. See below for an example.
* The code must be clear and written in English, comments included.


__Thanks for contributing to WorldPECore!__
